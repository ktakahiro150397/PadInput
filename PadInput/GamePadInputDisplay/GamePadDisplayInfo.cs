...
namespace PadInput.GamePadInputDisplay
{
    ...
    /// </summary>
    class GamePadDisplayInfo : NotifyPropertyChangedModel,IGamePadDisplayInfo
    {
        /// <summary>
        ...
        public GamePadDisplayInfo(IList<IGamePadSingleButtonData> pressedButtonList, IGamePadDirectionData gamePadDirectionData)
        {
            elapsedFrameCount = 1;
